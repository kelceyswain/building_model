...
def validate_upload_size(fieldfile_obj):
...
class Image(Content):
    ...
    body = models.ImageField(upload_to="uploads/", validators=[validate_upload_size])
...
class Sound(Image):
    ...
    body = models.FileField(upload_to='uploads/', validators=[validate_upload_size])
